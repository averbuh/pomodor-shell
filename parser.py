...
from database.create_activity import create_activity as ca
from database.delete_activity import delete_activity as da
from database.delete_activity import delete_completed_activity as dca
from database.create_activity import return_activities as ra
from database.create_activity import print_completed_activities as pca
from database.create_activity import copy_activity_from_complete as cafc 
...
def parser_cli():
    ...
    parser_update.add_argument('-p', '--plan', help='Plan', action='store_true')
